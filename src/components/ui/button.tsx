  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-200 border border-neutral-200 shadow-sm',
  {
    variants: {
      variant: {
        ...
        ghost:
          'hover:bg-accent hover:text-accent-foreground border-transparant shadow-none',
        muted: 'text-neutral-600 bg-neutral-200 hover:bg-neutral-200/80',
        teritary:
